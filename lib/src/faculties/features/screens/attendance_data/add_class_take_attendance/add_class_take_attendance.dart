...
class AddClassTakeAttendanceScreen extends StatefulWidget {
  const AddClassTakeAttendanceScreen({super.key});

  @override
  State<AddClassTakeAttendanceScreen> createState() =>
      _AddClassTakeAttendanceScreenState();
}

class _AddClassTakeAttendanceScreenState
    extends State<AddClassTakeAttendanceScreen> {
